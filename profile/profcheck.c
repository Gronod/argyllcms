...
int main(int argc, char *argv[]) {
	...
	int doaxes = 0;
	int dodecol = 0;
	static char ti3name[MAXNAMEL+1] = { 0 };	/* Input cgats file base name */
	cgats *icg;				/* input cgats structure */
	static char iccname[MAXNAMEL+1] = { 0 };	/* Input icc file base name */
	icmFile *rd_fp;
	icmErr err = { 0, { '\000'} };
	icRenderingIntent intent = icAbsoluteColorimetric;
	icc *rd_icco;
	icmLuSpace *luo;
	static char out_name[MAXNAMEL+1], *xl;		/* VRML/X3D name */
	vrml *wrl = NULL;
