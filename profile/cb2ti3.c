...
int main(int argc, char *argv[])
{
	...
	int verb = 0;
	static char tarname[MAXNAMEL+10+1] = { 0 };	/* Input .CMY file */
	static char inname[MAXNAMEL+10+1] = { 0 };		/* Input .nCIE file */
	static char outname[MAXNAMEL+10+1] = { 0 };	/* Output cgats .ti3 file base name */
	...
	strcat(inname,".CMY");
    strncpy(tarname,argv[fa++],MAXNAMEL); tarname[MAXNAMEL] = '\000';
	strcat(tarname,".nCIE");
