...
int main(int argc, char *argv[]) {
	...
	static char ipname[MAXNAMEL+1] = "";	/* Input icc profile - enables gamut map */
	static char sgname[MAXNAMEL+1] = "";	/* Image source gamut name */
	static char absstring[3 * MAXNAMEL +1];	/* Storage for absnames */
	...
	static char baname[MAXNAMEL+1] = "";	/* Input & Output base name */
	static char inname[MAXNAMEL+1] = "";	/* Input cgats file base name */
	static char outname[MAXNAMEL+1] = "";	/* Output cgats file base name */
