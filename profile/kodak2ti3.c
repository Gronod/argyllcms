...
int main(int argc, char *argv[])
{
	...
	int verb = 0;
	int limit = -1;
	static char tarname[MAXNAMEL+10+1] = { 0 };	/* optional 928 patch reference file */
	static char inname[MAXNAMEL+10+1] = { 0 };		/* Input .pat file base name */
	...
	for (fa = 1;fa < argc;fa++) {
		...
		if (argv[fa][0] == '-')	{	/* Look for any flags */
			...
			if (argv[fa][1] == '?')
				...
				if (na == NULL) usage();
				fa = nfa;
    			strncpy(tarname,na,MAXNAMEL); tarname[MAXNAMEL] = '\000';
			}
